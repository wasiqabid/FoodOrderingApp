...
class DessertsActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        viewModel = ViewModelProvider(this).get(DessertsViewModel::class.java)

        ViewCompat.setOnApplyWindowInsetsListener(findViewById(R.id.desserts_main)) { v, insets ->
        ...
        // RecyclerView Setup
        val recyclerView = findViewById<RecyclerView>(R.id.dessertsRecyclerView)
        ...
        // Observe Desserts
        viewModel.desserts.observe(this) { items ->
            if (items.isEmpty()) {
                Toast.makeText(this, "No desserts found in database. Check category spelling!", Toast.LENGTH_LONG).show()
            }

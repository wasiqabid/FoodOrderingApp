...
class BurgersActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        viewModel = ViewModelProvider(this).get(BurgersViewModel::class.java)

        ViewCompat.setOnApplyWindowInsetsListener(findViewById(R.id.burgers_main)) { v, insets ->
        ...
        // RecyclerView Setup
        val recyclerView = findViewById<RecyclerView>(R.id.burgersRecyclerView)
        ...
        // Observe Burgers
        viewModel.burgers.observe(this) { items ->
            if (items.isEmpty()) {
                Toast.makeText(this, "No burgers found in database. Check category spelling!", Toast.LENGTH_LONG).show()
            }
